...
## Before submitting an issue
 ...
 - If you're not using the latest master to generate API clients or server stubs, please give it another try by pulling the latest master as the issue may have already been addressed. Ref: [Getting Started]([https://github.com/openapitools/openapi-generator#getting-started](https://github.com/openapitools/openapi-generator#2---getting-started))
